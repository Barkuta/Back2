...
switch($method) {
    ...
    case "POST":
        ...
        $sql = "INSERT INTO Exchange(id, count, total_price, wallet, email, ticker1, ticker2, created_at) VALUES(null, :count, :total_price, :wallet, :email, :ticker1, :ticker2, :created_at)";
        $stmt = $conn->prepare($sql);
